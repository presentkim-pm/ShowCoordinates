...
namespace kim\present\showcoordinates\task;
...
class CheckUpdateAsyncTask extends AsyncTask{
	...
	private const RELEASE_URL = "https://api.github.com/repos/PresentKim/ShowCoordinates-PMMP/releases/latest";
	...
	public function __construct(){
		$this->cachePath = ShowCoordinates::getInstance()->getDataFolder() . ".latestCache";
	}
	...
	public function onCompletion(Server $server) : void{
		$plugin = ShowCoordinates::getInstance();
